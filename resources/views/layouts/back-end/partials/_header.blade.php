        ...
        <div class="navbar-nav-wrap">
            <div class="navbar-brand-wrapper">
                ...
                <a class="navbar-brand" href="" aria-label="">
                    <img class="navbar-brand-logo" onerror="this.src='{{ asset('public/assets/back-end/img/logo.jpg') }}'"
                        src="{{ asset('public/assets/back-end/img/logo.jpg') }}" alt="Logo">
                    <img class="navbar-brand-logo-mini"
                        onerror="this.src='{{ asset('public/assets/back-end/img/logo.jpg') }}'"
                        src="{{ asset('public/assets/back-end/img/logo.jpg') }}" alt="Logo">
                </a>
                <!-- End Logo -->
            </div>
                                    ...
                                    @if ($lang == 'ar' )
                                        <a class="topbar-link dropdown-toggle d-flex align-items-center title-color"
                                            ...
                                            <img class="{{ Session::get('locale') === 'ar' ? 'ml-2' : 'mr-2' }}"
                                                width="20"
                                                src="{{ asset('public/assets/front-end') }}/img/flags/sa.png"
                                                alt="Eng">
                                        </a>
