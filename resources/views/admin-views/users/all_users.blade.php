    ...
    <div class="content container-fluid">
        ...
        <div class="mb-3">
            <h2 class="h1 mb-0 d-flex gap-2">
                <img width="30" src="{{ asset('/public/assets/back-end/img/all_users.jpg') }}" alt="">
                {{ __('roles.all_users') }}
                <span class="badge badge-soft-dark radius-50 fz-14">{{ $users->count() }}</span>
            </h2>
        </div>
        <!-- End Page Title -->
