...
@section('content')
    <div class="content container-fluid">
        ...
        <!-- Form -->
        <form class="product-form text-start" action="{{ route('user_management.store') }}" method="POST" enctype="multipart/form-data" >
            @csrf
            <!-- general setup -->
            <div class="card mt-3 rest-part">
                <div class="card-header">
                    <div class="d-flex gap-2">
                        ...
                        <h4 class="mb-0">{{ __('roles.create_user') }}</h4>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row">
